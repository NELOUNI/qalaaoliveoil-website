        ...
        <div className="bg-card rounded-2xl shadow-lg mt-8 p-8">
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-neutral max-w-none">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">Use of Our Services</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">Product Information</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <section>
            ...
            <div className="prose prose-neutral max-w-none">
              ...
              <h4 className="text-lg font-semibold text-foreground mb-2">Essential Cookies</h4>
              ...
              <h4 className="text-lg font-semibold text-foreground mb-2">Analytics Cookies</h4>
              <p className="text-muted-foreground leading-relaxed mb-3">
                These cookies help us understand how visitors interact with our website by collecting and reporting
                information anonymously. This helps us improve our website's performance.
              </p>

              <h4 className="text-lg font-semibold text-foreground mb-2">Marketing Cookies</h4>
              <p className="text-muted-foreground leading-relaxed mb-3">

      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="space-y-4">
            <ProductImageGallery
              images={product.gallery?.length ? product.gallery : product.image_url ? [product.image_url] : []}
            />
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-xl text-[var(--antique-gold)]/80 mb-6">
            ...
            <div className="bg-[var(--matte-black)]/80 p-6 rounded-lg border border-[var(--antique-gold)]/30">
              ...
              <div className="mt-4 text-sm text-[var(--antique-gold)]/80">
                <div className="flex items-center">
                  <Calendar className="w-4 h-4 mr-1 shrink-0" />
                  {t("product.harvest")}:{" "}
                  <span className="latin-numerals ms-1" lang="en" dir="ltr">
                    {t("product.november-2025")}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 pt-6 border-t">
              <div>
                ...
                <p className="text-[var(--antique-gold)]/80 latin-numerals" lang="en" dir="ltr">
                  {"<0.2"}
                </p>
              </div>
              <div>
